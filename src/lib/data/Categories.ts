...
export const CATEGORY_LIST: readonly Category[] = Object.freeze(
  [
    ...
    { color: '#FFFFFF', fixed_id: 9, group_id: 'facilities', name: 'First Aid', z_index: 36 },
    { color: '#1BA5D1', fixed_id: 10, group_id: 'facilities', name: 'Toilets', z_index: 35 },
    ...
    { color: '#5AD8FF', fixed_id: 14, group_id: 'facilities', name: 'Showers', z_index: 33 },
    { color: '#FDDA27', fixed_id: 15, group_id: 'facilities', name: 'Charging Station', z_index: 28 },
    { aliases: ['Wheelchair Access'], color: '#5A8E21', fixed_id: 16, group_id: 'facilities', name: 'Disabled Facilities', z_index: 39 },
    { color: '#B99946', fixed_id: 17, group_id: 'festival', name: 'VIP', z_index: 27 },
    { color: '#4CC0C7', fixed_id: 18, group_id: 'facilities', name: 'Info', z_index: 26 },
    ...
    { aliases: ['Tokens', 'Skullies'], color: '#6A8F71', fixed_id: 22, group_id: 'facilities', name: 'Vouchers', z_index: 24 },
    { color: '#FFA44E', fixed_id: 23, group_id: 'facilities', name: 'Wristbands', z_index: 23 },
    { color: '#8DAA9D', fixed_id: 24, group_id: 'travel_access', name: 'Bike Parking', z_index: 31 },
    { color: '#C58EE2', fixed_id: 25, group_id: 'facilities', name: 'Lost & Found', z_index: 21 },
    { color: '#D04D4D', fixed_id: 26, group_id: 'facilities', name: 'Ticketing', z_index: 20 },
    { color: '#505D6D', fixed_id: 27, group_id: 'travel_access', name: 'Disability Parking', z_index: 19 },
    { aliases: ['Cashless Helpdesk'], color: '#1F66B8', fixed_id: 28, group_id: 'facilities', name: 'ATM', z_index: 18 },
    ...
    { aliases: ['Recycle Point'], color: '#7AA54F', fixed_id: 31, group_id: 'facilities', name: 'Recycle Points', z_index: 15 },
    { color: '#C94959', fixed_id: 32, group_id: 'facilities', name: 'Lockers', z_index: 37 },
    { color: '#04052E', fixed_id: 33, group_id: 'festival', name: 'WiFi Zone', z_index: 13 },
    { color: '#9AACAB', fixed_id: 34, group_id: 'festival', name: 'General', z_index: 8 },
    ...
    { aliases: ['Tent Tribune'], color: '#7D767E', fixed_id: 42, group_id: 'festival', name: 'Tribune', z_index: 9 },
    { color: '#000000', fixed_id: 43, group_id: 'festival', name: 'Crosses', z_index: 11 },
